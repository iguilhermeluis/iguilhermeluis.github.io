...
function GerarGraficoMultiAxisXY(chartDivId, data)//, titulo, legendaX, legendaY, valorX, valorY, valor, toolTip, corFundo, range)
{
    ...
    QtdPedidosSeries.tooltipText = "[bold]Cluster:[/] {ClusterId}\n{InterpretacaoFM} - {InterpretacaoR}\n[bold]Total de Pedidos[/]: {SumF}\n[bold]Frequência Média:[/] {AvgF} pedido(s)";

    var QtdPedidosBullet = QtdPedidosSeries.bullets.push(
    ...
    var SomatorioMBullet = SomatorioMSeries.bullets.push(new am4charts.CircleBullet());
