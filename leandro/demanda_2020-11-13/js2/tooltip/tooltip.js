const criarToolTip = (tooltipID, panelCheckID, chartID) => {

    document.getElementById(chartID).addEventListener("mouseover", (e) => buscarOpcaoSelecionada(), false);

    const buscarOpcaoSelecionada = () => {
    ...
    return (
    "" +
    "<div tabindex='1' id='" + tooltipID + "' style='background: #393b54; font-family: verdana; sans-serif; color: white; border-radius: 6px; width: 300px; position: relative; font-size: 12px; display: flex; justify-content: space-between; flex-direction: column;'>" +
    ...
    "                </tr>" +
    "                <tr data-value='SumF' data-color='#7a59ad'>" +
