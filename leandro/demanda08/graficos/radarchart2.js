...
function gerarRadarChart(
  ...
  series1.dataFields.categoryY = "InterpretacaoR";
  series1.dataFields.valueX = "QtdClientes";
  series1.stacked = true;
  series1.columns.template.propertyFields.fill = "CorFundoR";
  series1.columns.template.propertyFields.stroke = "CorFundoR";

  // Add series

  chart.data = data; //processDataStacker(data);
